...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-silence-1df8
```

A live public deployment of this template is available at [https://bitter-silence-1df8.templates.workers.dev](https://bitter-silence-1df8.templates.workers.dev)
